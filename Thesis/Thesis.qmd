...
The types of deviations investigated in this simulation are based on which deviations are commonly reported. This means that even in preregistered papers, type I error rates might be much higher than the aspired 5%. As of yet, researchers often fail to report their reasons for  deviating [source]. This becomes a much bigger issue when the current results show that choosing to deviate opportunistically leads to a much larger inflation in the type I error rate than forced deviations. 
Opportunistic deviation was limited to singular deviations in this research, meaning that only one deviation was done at a time, deviations could not be combined. These results might therefore underestimate the actual impact of opportunistic deviations and real type I error rates in deviation papers might be a lot higher. 
...
As a result, one of the most important findings of this project is the importance of proper registration of the reasons for deviations. [source] et al. showed that very few researchers that deviate also report on why they did so. The fact that the chance of false positives increases so much when deviating opportunistically indicates that this is an important roadblock in improving the reliability of research. 
