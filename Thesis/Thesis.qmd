...
set.seed()
rq1.no <- analysis(1600, 200, 0, 0.2, 0.06, 0.06, "y_no")
rq2.no <- choice(rq1.no)

#The effect scenario
set.seed()
rq1.yes <- analysis(1600, 200, 0, 0.2, 0.06, 0.06, "y_yes")
...
rq2.no.plot <- paste0(round(((rq.no.sig)/160*100),1),"%")

rq2.no.plot <- rbind(w1[1,], c(34, "21.2%", "Opportunistic"))
