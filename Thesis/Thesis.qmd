...
kable(rq2.table,
      format    = "latex",   # use "html" if rendering to HTML
      booktabs  = TRUE,
      col.names = c(" ", "Effect condition", "No-effect condition"),
      digits    = 2
) |>
  kable_styling(
