...
In order to assess differences between outlier exclusion criteria, the data need to include outliers. To simulate outliers, 5% of the data is simulated with an increased or decreased value for $\epsilon$.
