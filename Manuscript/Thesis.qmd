...
In the Statistical Model domain, the error rates were mostly unaffected. Power was unaffected in the continuous and dichotomous covariate conditions (`r rq1.yes.plot[rq1.yes.plot$conditions == "Continuous covariate", "n.sig.perc"]*100`% and `r rq1.yes.plot[rq1.yes.plot$conditions == "Dichotomous covariate", "n.sig.perc"]*100`%, respectively). However, a substantial deflation in power was observed in the alternative outcome condition, resulting in a power of `r rq1.yes.plot[rq1.yes.plot$conditions == "Alternative outcome", "n.sig.perc"]*100`%. No apparent effects on the type I error rate were observed in any of the conditions in the Statistical Model domain (continuous covariate = `r rq1.no.plot[rq1.no.plot$conditions == "Continuous covariate", "n.sig.perc"]*100`%, dichotomous covariate = `r rq1.no.plot[rq1.no.plot$conditions == "Dichotomous covariate", "n.sig.perc"]*100`%, outcome switching = `r rq1.no.plot[rq1.no.plot$conditions == "Alternative outcome", "n.sig.perc"]*100`%).
...
The type I error rate and power were more severely affected by deviating opportunistically. In Research Question 2, the effects of choosing to deviate in order to achieve significant results were investigated. Power increased to `r rq2.yes.nsig.perc*100`% in the effect scenario. This result is unsurprising, as the condition was designed to maximize the number of significant results. The total type I error rate for this condition was `r rq2.no.perc*100`%. When the baseline scenario was non-significant, a significant deviation result was still found 12.8% of the time. This means that when researchers look at their outcomes and find non-significant results, choosing to deviate can still result in significant findings 1 out of 8 times. Knowing why a researcher deviated and whether they did so based on their initial results is therefore necessary to elucidate the true harm of a deviation.
