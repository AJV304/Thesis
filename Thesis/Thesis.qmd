...
baseline falls within range as hoped.

-dichotomous, baseline, 195, continuous and 205 within range

-alternative, cook and smallest sample: low power

-big sample and strict z increased power

-strict z surprising???

Small deviations in sample size make little difference on power levels, neither do covariates. Larger differences in sample size affect power more strongly showing an increase in power and decrease in power. Similarly, deviations in outlier exclusion criteria has affects on results.
...
-only small increase in sample size and strict z show increase in significant p-values
