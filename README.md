...
#### `01_datageneration`
Although the data sets are also available in this repository, scripts to generate the data were also included. There are two scripts, one for the original analysis of repetition size 1,600 (`datageneration.R`) and one for the robustness check with repetition size 10,000 (`datageneration_robust.R`).
...
## License
This work is licensed under the Creative Commons Attribution-ShareAlike 4.0 International License (CC BY-SA 4.0). This license allows people to share, distribute and build upon my work as long as proper attribution is given, and any derivative work is released under the same license. This ensures open availability of future work. For more information, see [LICENSE](https://github.com/AJV304/Thesis/blob/f073e80ec5840a0ddc324937b49cc25814a422db/LICENSE.md).
